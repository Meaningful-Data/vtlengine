...
class DEMO(DEMOHelper):
    ...
    def test_DEMO1(self):
        ...
        code = 'DEMO1'
        number_inputs = 4
        references_names = ['agg.DS2_tim', 'agg.DS1_tim', 'agg.val', 'agg.exRate', 'agg.DS1_conv', 'agg.DS1_enr',
                            'agg.DS1_fin',
                            'aggr.numDPCouYear', 'aggr.numYearCou', 'aggr.numCouYear', 'aggr.agg2', 'aggr.agg1',
