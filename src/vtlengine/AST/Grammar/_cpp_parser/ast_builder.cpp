...
static void do_cleanup() {
    // Use .release() to set internal PyObject* to nullptr without calling Py_DECREF.
    // This prevents segfaults when static destructors fire after Python interpreter shutdown.
    py_Start.release();
    py_Assignment.release();
    py_PersistentAssignment.release();
    py_VarID.release();
    py_UnaryOp.release();
    py_BinOp.release();
    py_MulOp.release();
    ...
    py_JoinOp.release();
    py_Constant.release();
    py_ParamConstant.release();
    py_Identifier.release();
    py_ID.release();
    py_Collection.release();
    py_Windowing.release();
    py_OrderBy.release();
    py_Analytic.release();
    py_RegularAggregation.release();
    py_RenameNode.release();
    py_Aggregation.release();
    py_TimeAggregation.release();
    py_If.release();
    py_CaseObj.release();
    py_Case.release();
    py_Validation.release();
    py_ComponentType_AST.release();
    py_ASTScalarType.release();
    py_DatasetType_AST.release();
    py_Types.release();
    py_Argument.release();
    py_Operator.release();
    py_DefIdentifier.release();
    py_DPRIdentifier.release();
    py_HRBinOp.release();
    py_HRUnOp.release();
    py_HRule.release();
    py_DPRule.release();
    py_HRuleset.release();
    py_HROperation.release();
    py_DPValidation.release();
    py_DPRuleset.release();
    py_EvalOp.release();
    py_NoOp.release();
    py_ParFunction.release();
    py_Comment.release();
    py_String.release();
    py_Integer.release();
    py_Number.release();
    py_Boolean.release();
    py_Date.release();
    py_TimePeriod.release();
    py_Duration.release();
    py_TimeInterval.release();
    py_Role.release();
    py_Component.release();
    py_Dataset.release();
    py_Scalar.release();
    py_SemanticError.release();
    g_initialized = false;
}
...
static void cleanup_phase3() {
    py_Validation.release();
    py_CHInputMode_cls.release();
    py_HRInputMode_cls.release();
    py_ValidationMode_cls.release();
    py_ValidationOutput_cls.release();
    py_HierarchyOutput_cls.release();
    py_DATASET_PRIORITY.release();
    py_de_ruleset_elements.release();
