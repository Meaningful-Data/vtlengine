...
class Assignment(Binary):
    ...
    @classmethod
    def validate(cls, left_operand: Any, right_operand: ALL_MODEL_TYPES) -> ALL_MODEL_TYPES:
    ...
    @classmethod
    def evaluate(cls, left_operand: Any, right_operand: ALL_MODEL_TYPES) -> ALL_MODEL_TYPES:
