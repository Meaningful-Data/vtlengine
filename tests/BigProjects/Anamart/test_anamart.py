...
class ASeries(AnamartHelper):
    ...
    def test_2(self):
        ...
        code = 'A02'
        number_inputs = 2
        references_names = ["NLE", "LE", "LE2", "LE_3", "LE_FLL", "LE_JN", "NLE2", "DBTR",
                            "ANAMART_ENTTY_LE"]
    ...
    def test_3(self):
        ...
        code = 'A03'
        number_inputs = 1
        references_names = ["DBTR_FCT_NN_PRFRMNG", "DBTR_FCT_TTL_NN_PFRMNG", "DBTR_FCT",
                            "DBTR_FCT_TTL", "DBTR_FCT_JN",
    ...
    def test_6(self):
        ...
        code = 'A06'
        number_inputs = 1
        references_names = ["DBTR_GGRPHCL", "DBTR_GGRPHCL_T", "ANAMART_ENTTY_GGRPHCL_P",
...
class BSeries(AnamartHelper):
    ...
    def test_3(self):
        ...
        code = 'B03'
        number_inputs = 3
        references_names = ["INSTRMNT_FCT_CRDTR_NLL", "INSTRMNT_FCT_CRDTR",
                            "INSTRMNT_FCT_CRDTR_NOA",
                            "NMBR_CRDTRS_NT_OA_P", "NMBR_CRDTRS_NT_OA_D",
                            "NMBR_CRDTRS_PR_INSTRMNT_P",
                            "NMBR_CRDTRS_PR_INSTRMNT", "INSTRMNT_FCT_TRNSFRRD_AMNT",
    ...
    def test_4(self):
        ...
        code = 'B04'
        number_inputs = 7
        references_names = ["INSTRMNT_FCT_CV_1", "INSTRMNT_PRTCTN_TTL_INSTRMNT",
                            "INSTRMNT_FCT_CV_2", "ANAMART_CV",
    ...
    def test_5(self):
        ...
        code = 'B05'
        number_inputs = 3
        references_names = ["INSTRMNT_PRTCTN_RCVD_K", "INSTRMT_PRTCN_3PTPC_P",
                            "INSTRMT_PRTCN_3PTPC",
...
class CSeries(AnamartHelper):
    ...
    def test_3(self):
        ...
        code = 'C03'
        number_inputs = 2
        references_names = ["PRTCTN_FCT_AGGR_FV", "INSTRMNT_FCT_AGGR_KP", "INSTRMNT_FCT_AGGR_P",
                            "INSTRMNT_FCT_AGGR",
                            "ANAMART_PRTCTN_AGGR"]
    ...
    def test_4(self):
        ...
        code = 'C04'
        number_inputs = 2
        references_names = ["PRTCTN_RCVD_KP", "PRTCTN_RCVD_AGG", "INSTRMTN_PRTCT_RCVD_AGG",
                            "RTS_DNMNTR",
