...
# Whitelists are read from _smv_whitelist.json (generated by scripts/configure_doc_versions.py)
_smv_whitelist_path = Path(__file__).parent / "_smv_whitelist.json"
if _smv_whitelist_path.exists():
    _smv_config = json.loads(_smv_whitelist_path.read_text(encoding="utf-8"))
    smv_tag_whitelist = _smv_config.get("smv_tag_whitelist", r"^v\d+\.\d+\.\d+$")
    smv_branch_whitelist = _smv_config.get("smv_branch_whitelist", r"^main$")
else:
